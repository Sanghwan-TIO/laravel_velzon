    ...
    <div class="email-menu-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                ...
                <div>
                    <h5 class="fs-13 text-uppercase text-muted mt-4">Labels</h5>
                ...
                <div class="border-top border-top-dashed pt-3 mt-3">
                    ...
                    <h5 class="fs-13 text-uppercase text-muted mb-3">Chat</h5>
                            ...
                            <a role="button" class="btn w-100 text-start px-0 bg-transparent shadow-none collapsed"
                                ...
                                <div class="d-flex align-items-center text-muted">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-15 text-truncate mb-0">Jack Davis</h5>
                                        <div class="text-truncate fs-14">to: me</div>
                                    </div>
                                    <div class="flex-shrink-0 align-self-start">
                                        <div class="text-muted fs-13">09 Jan 2022, 11:12 AM</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="accordion-header">
                            <a role="button" class="btn w-100 text-start px-0 bg-transparent shadow-none collapsed"
                                ...
                                <div class="d-flex align-items-center text-muted">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-15 text-truncate mb-0">Anna Adame</h5>
                                        <div class="text-truncate fs-14">to: jackdavis@email.com</div>
                                    </div>
                                    <div class="flex-shrink-0 align-self-start">
                                        <div class="text-muted fs-13">09 Jan 2022, 02:15 PM</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="accordion-header">
                            <a role="button" class="btn w-100 text-start px-0 bg-transparent shadow-none"
                                ...
                                <div class="d-flex align-items-center text-muted">
                                    ...
                                    <div class="flex-shrink-0 align-self-start">
                                        <div class="text-muted fs-13">10 Jan 2022, 10:08 AM</div>
                                    </div>
                                </div>
                            </a>
                        </div>
