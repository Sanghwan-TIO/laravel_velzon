                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+13.11%<span class="text-muted ms-2 fs-13 text-uppercase">(btc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+15.08%<span class="text-muted ms-2 fs-13 text-uppercase">(ltc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+08.57%<span class="text-muted ms-2 fs-13 text-uppercase">(etc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fw-medium mb-0">-09.21%<span class="text-muted ms-2 fs-13 text-uppercase">(bnb)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+12.07%<span class="text-muted ms-2 fs-13 text-uppercase">(dash)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+14.99%<span class="text-muted ms-2 fs-13 text-uppercase">(usdt)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fw-medium mb-0">-05.07%<span class="text-muted ms-2 fs-13 text-uppercase">(neo)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
